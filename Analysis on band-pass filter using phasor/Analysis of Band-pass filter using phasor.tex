...
\begin{figure}[h]
    \centering
    \subfigure[Single Resistance Band-Pass Filter]{\includegraphics[width=0.45\textwidth]{./FTF.png}\hfill}
    \subfigure[Various levels of Resistance]{\includegraphics[width=0.45\textwidth]{./FTF_R.png}\hfill}
...
\begin{figure}[h]
    \centering
    \subfigure[Single Resistance Band-Pass Filter]{\includegraphics[width=0.45\textwidth]{./ARF.png}\hfill}
    \subfigure[Various levels of Resistance]{\includegraphics[width=0.45\textwidth]{./ARF_R.png}\hfill}
